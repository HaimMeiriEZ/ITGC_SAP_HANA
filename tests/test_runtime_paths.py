...
class RuntimeDataTests(unittest.TestCase):
    ...
    def test_default_db_path_under_install_root(self) -> None:
        self.assertEqual(default_db_path(), get_install_root() / "audit_system.db")
    ...
    def test_ensure_runtime_data_seeds_from_bundle_when_missing(self) -> None:
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            self.assertTrue((dest_root / "config" / "settings.json").exists())
    ...
    def test_knowledge_base_dir_under_install_root(self) -> None:
